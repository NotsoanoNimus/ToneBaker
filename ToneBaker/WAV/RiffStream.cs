...
namespace ToneBaker.WAV {
    ...
    public sealed class RiffFileFormat {
        ...
        private interface IRiffFileChunk {
            /// <summary>
        ...
        public sealed class RIFF_CHUNK : IRiffFileChunk {
        ...
        /// </summary>
        /// <see cref="http://soundfile.sapp.org/doc/WaveFormat/"/>
        public sealed class FMT_CHUNK : IRiffFileChunk {
            ...
            public FMT_CHUNK(AudioFormat audioFormat) {
        ...
        /// </summary>
        /// <see cref="http://soundfile.sapp.org/doc/WaveFormat/"/>
        public sealed class DATA_CHUNK : IRiffFileChunk {
    ...
    /// </summary>
    /// <see cref="http://soundfile.sapp.org/doc/WaveFormat/"/>
    /// <seealso cref="RiffFileFormat"/>
    public sealed class RiffStream : IDisposable {
        internal bool _disposed = false;
        private RiffFileFormat.RIFF_CHUNK riff;
        private RiffFileFormat.FMT_CHUNK fmt;
        private RiffFileFormat.DATA_CHUNK data;
